...
window.ModuleLoader = function(config) {
  ...
  var tempHolders = {$module : true};
  (this.config.holders || "").replace(/[^\,]*/g, function(a){tempHolders[a] = true;});
  this.config.holders = tempHolders;
...
var p = {
  ...
  getBase         : function () { return this.config.path.base; },

  getBlankPageUrl : function () { return this.simplifyURL(this.config.path.blankPage); },
